...
$(document).ready(function(){
    var images3 = ["img/d2.jpg",
        "img/d4.jpg", "img/d7.jpg"];
    ...
    setInterval(changeBackground3, 3000);
...
$(document).ready(function(){
    var images5 = ["img/a1.jpg",
        "img/a4.jpg","img/a5.jpg"];
    ...
    setInterval(changeBackground5, 3000);
...
$(document).ready(function(){
    var images6 = [
        "img/c5.jpeg", "img/c4.jpeg", "img/c3.jpeg","img/c2.jpeg", "img/c1.jpeg"];
    ...
    setInterval(changeBackground6, 3000);
...
$(document).ready(function(){
    ...
    setInterval(changeBackground7, 3000);
...
/*Boutique en ligen-----------------------------------------------------------------*/
$(document).ready(function(){
    var images8 = ["boutique/a1.jpg",
        "boutique/a2.jpg", "boutique/a3.jpg",
    "boutique/a5.jpg","boutique/a4.jpg","boutique/a15.jpg",];
    ...
    setInterval(changeBackground8,1000);
